...
def train_model():
    # Initialize datasets
    train_dataset = BinaryDataset(r'c:\Users\btofi\Shakespeare-Trained-LLm\Subword-level-Token\train.bin')
    val_dataset = BinaryDataset(r'c:\Users\btofi\Shakespeare-Trained-LLm\Subword-level-Token\val.bin')
    
    train_loader = DataLoader(train_dataset, batch_size=BATCH_SIZE, shuffle=True)
    val_loader = DataLoader(val_dataset, batch_size=BATCH_SIZE, shuffle=True)

    # Model parameters
    vocab_size = 64  # For byte-level encoding
